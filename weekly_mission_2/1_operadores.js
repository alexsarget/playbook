// Ejemplo 1: forEach para imprimir elementos de una lsita 
const numbers=[1,2,3,4,5];
console.log("Ejemplo 1: Imprimiendo los elementos de una lista")
numbers.forEach(num=>console.log(num))

//Ejercicio 2_ for Each para calcular la suma de todos los elementos de una lista
let sum =0;
const numbers2=[1,2,3,4,5];
numbers2.forEach(num=>sum+=num)
console.log("Ejercicio2: Cálculo de la suma de los elementos de la lista")
console.log(sum)

//Ejercicio 3: forEach para imprimir los países en letras mayúsculas
const countries=['Alemania','Honduras','Londres','Argentina','España']
console.log("Ejercicio5: Imprimiendo la lista de países en mayusculas")
...
const names = ['Cristian', 'Enrique', 'Sophia', 'Valeria']
